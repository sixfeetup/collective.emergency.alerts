...
from collective.emergency.alerts.testing import (
    COLLECTIVE_EMERGENCY_ALERTS_INTEGRATION_TESTING,
)  # noqa
...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(
            self.installer.isProductInstalled("collective.emergency.alerts")
        )

    def test_browserlayer(self):
        """Test that ICollectiveEmergencyAlertsLayer is registered."""
        from collective.emergency.alerts.interfaces import (
            ICollectiveEmergencyAlertsLayer,
        )
